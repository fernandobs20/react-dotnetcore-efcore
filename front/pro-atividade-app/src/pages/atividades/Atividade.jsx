  ...
  return (
    <>
      ...
      <TitlePage title={'Atividade ' + (atividade.id !== 0 ? atividade.id : "")}>
        <Button variant="outline-secondary" onClick={novaAtividade}> <i className="fas fa-plus"></i></Button>        
      </TitlePage>
      ...
      >
        ...
        <Modal.Body>
          <p>Você tem certeza que deseja excluir a atividade {atividade.id} ?</p>
        </Modal.Body>
